...
export class App extends Widget<null> {
    ...
    tutorial = new InfoPanel(this,
        ...
        [
            ...
            `Whenever you buy things from the market, the economy has to produce things not for consumption but for your needs. People and firms who would be producing goods will be working for you. This is known as the Crowding-Out effect. As a result, firms sometimes cannot afford their inputs, and have to cut costs, which lowers their income, makes them not able to afford inputs, and cut costs in a downward spiral. You will see this as a fluctuating capacity with a blinking danger sign. In this case, you can help the firm recover by providing them with their inputs. After a few rounds of subsidies, the firm will resume its function. `,
